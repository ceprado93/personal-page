...
const About = () => {
  ...
  return (
    <>
      <section className="about">
        <Container>
          {reveal.down === "reveal fadeInDown visible" ? (
            <h2 className={reveal.down}>About</h2>
          ) : (
            ...
            <Col md={{ span: 7, offset: 1 }}>
              <div className={reveal.left}>
                ...
                <p className="responsive-second-p">
                  After graduating from Uni, I spent my first professional years working between Europe and South
                  America in various industries and roles. In 2019, I decided to step out of my comfort zone, pack my
                  bags and move to the other end of the world, Australia, where I lived for 1 year and a half.
                </p>
                <p className="responsive-second-p">
      ...
      <Link to="/portfolio">
        <Button className="bottom-btn">Portfolio</Button>
      </Link>
    </>
  );
};
